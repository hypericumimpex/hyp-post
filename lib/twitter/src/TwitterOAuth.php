...
class TwitterOAuth extends Config
{
     ...
     */
    public function __construct($consumerKey, $consumerSecret, $oauthToken = null, $oauthTokenSecret = null , $proxy = null)
    {
    ...
    private function mediaInitParameters(array $parameters)
    {
        $return = [
            'command' => 'INIT',
            'media_type' => isset($parameters['media_type']) ? $parameters['media_type'] : '',
