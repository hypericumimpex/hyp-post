	...
	<div style="width: 50%;">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=esc_html__('Once a new account has been added all the included \'my\' pages will be automatically added as well. You will be able to share any posts to these pages.' , 'fs-poster')?></div>
			</div>
	...
	<div style="width: 50%;">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=esc_html__('Once a new account has been added all the included groups will be automatically added as well. You will be able to share any posts to these groups.' , 'fs-poster')?></div>
			</div>
			<div class="fs_s_input">
				<div class="fs_onoffswitch">
	...
	<div style="width: 50%;" id="hide2">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=esc_html__('Within the added account, groups will have a limit in regards to amount of loads (you will have a MAX of 1000 groups to load).' , 'fs-poster')?></div>
			</div>
			<div class="fs_s_input">
	...
	<div style="width: 50%;">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=esc_html__('Once a new account has been added all the included \'liked\' pages will be automatically added as well. You will be able to share any posts to these pages.' , 'fs-poster')?></div>
			</div>
			<div class="fs_s_input">
				<div class="fs_onoffswitch">
					<input type="checkbox" name="fs_load_liked_pages" class="fs_onoffswitch-checkbox" id="fs_load_liked_pages"<?=get_option('fs_load_liked_pages', '0')?' checked':''?> onchange="if($(this).is(':checked')){ $('#hide1').fadeIn(fadeSpeed); }else{ $('#hide1').fadeOut(fadeSpeed); }">
					<label class="fs_onoffswitch-label" for="fs_load_liked_pages"></label>
				</div>
			</div>
		</div>
	</div>
	<div style="width: 50%;" id="hide1">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=esc_html__('Within the added account, \'liked\' pages will have a limit in regards to amount of loads (you will have a MAX of 1000 \'liked\' pages to load).' , 'fs-poster')?></div>
			</div>
			<div class="fs_s_input">
...
<div style="display: flex;">
	<div class="fs_setting_item">
		<div class="fs_setting_item_label" style="width: 55%;">
			...
			<div class="fs_s_help"><?=esc_html__('Which method you want to share your posts. With uploading featured image or uploading all contains images in post or only attach post link.' , 'fs-poster')?></div>
		</div>
