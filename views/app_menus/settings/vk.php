	...
	<div style="width: 50%;">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=esc_html__('Once a new account has been added all the included \'own\' communities (page / group / event) will be automatically added as well. You will be able to share any posts to these communities.' , 'fs-poster');?></div>
			</div>
	...
	<div style="width: 50%;">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=esc_html__('Once a new account has been added all the included communities (page / group / event) will be automatically added as well. You will be able to share any posts to these communities.' , 'fs-poster');?></div>
			</div>
			<div class="fs_s_input">
				<div class="fs_onoffswitch">
	...
	<div style="width: 50%;">
		<div class="fs_setting_item">
			<div class="fs_setting_item_label">
				...
				<div class="fs_s_help"><?=esc_html__('If you want to upload featured image to VK and not attach image from link, then activate this option. Else way plugin will only send post link and VK automatically will attach image from the link.' , 'fs-poster');?></div>
			</div>
			<div class="fs_s_input">
				<div class="fs_onoffswitch">
