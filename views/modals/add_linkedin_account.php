...
<?php
$applications = wpFetchAll('apps' , ['driver' => 'linkedin']);
?>
<style>
	.linkedin_logo > img
	{
...
<div style="width: 100%; margin-top: 47px; display: flex; justify-content: center; align-items: center;">
	<div class="linkedin_logo"><img src="<?=plugin_dir_url(__FILE__).'../../images/linkedin.svg'?>"></div>
	<div style="width: 45%;">
...
<script>
	...
	function compleateOperation( status, errorMsg )
	{
		if( status )
		{
			...
			$('#account_supports .social_network_div[data-setting="linkedin"]').click();
		}
		else
		{
