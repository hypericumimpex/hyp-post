...
<?php
$applications = wpFetchAll('apps' , ['driver' => 'ok']);
?>
<style>
	.ok_logo > img
	{
...
<div style="width: 100%; margin-top: 47px; display: flex; justify-content: center; align-items: center;">
	<div class="ok_logo"><img src="<?=plugin_dir_url(__FILE__).'../../images/ok.svg'?>"></div>
	<div style="width: 45%;">
...
<script>
	...
	function compleateOperation( status, errorMsg )
	{
		if( status )
		{
			...
			$('#account_supports .social_network_div[data-setting="ok"]').click();
		}
		else
		{
	...
	$("#addAccountBTN").click(function ()
	{
		...
		{
			openURL = "<?=standartFSAppRedirectURL('ok')?>&proxy=" + $("#proxyInput").val();
		}
